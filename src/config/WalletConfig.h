...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "134";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "PROT";
    ...
    const std::string daemonName = "Protectcoind";

    /* The name to call this wallet */
    const std::string walletName = "Prowallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "do not run-service";
